...
def make_provider(config: dict[str, Any]) -> Any:
    ...
    provider parameters that this Ronin version doesn't know about).
    ...
    # forward-compat profiles may carry extra fields that this Ronin
    # version's constructor doesn't understand. The intent is "old
    # Ronin reads new profile, ignores unknown fields, runs anyway."
    import inspect
