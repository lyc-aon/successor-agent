...
for `successor`, `hero.txt` is separate empty-state chat art and not
...
from .successor import SuccessorIntro, run_successor_intro, successor_intro_frame_paths

__all__ = ["SuccessorIntro", "run_successor_intro", "successor_intro_frame_paths"]
