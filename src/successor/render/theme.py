...
def oklch_to_rgb(L: float, C: float, h: float) -> int:
    ...
    r = 4.0767416621 * l_cubed - 3.3077115913 * m + 0.2309699292 * s
    g = -1.2684380046 * l_cubed + 2.6097574011 * m - 0.3413193965 * s
    b_lin = -0.0041960863 * l_cubed - 0.7034186147 * m + 1.7076147010 * s
