...
@tool decorator and prove the loader runs end-to-end. This registry is
separate from the built-in `bash` capability, which is already wired
into the chat. `successor tools` inventories these Python-import tools.
"""
